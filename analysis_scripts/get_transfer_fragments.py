...
num_Chr, num_mito, num_plastid = hfanno.run_transfer_blastn(chr_absolute_path, mito_absolute_path, plastid_absolute_path, soft_paths_dict)
hfanno.merge_numt_nupt(num_Chr, num_mito, num_plastid)
hfanno.get_raw_transfer_groups(num_Chr)
