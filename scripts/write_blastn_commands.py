...
for id in ids:
    ...
    with open(sys.argv[2] + "_commands/runme_" + ID + ".sh", "at") as fout:
        ...
        print("python ../../scripts/analysis_blastn.py tmp/blastn_" + sample + "_" + sys.argv[2] + ID + "_" + ".xml " + sample + "_" + sys.argv[2] + ".fa > tmp/blastn_" + sample + "_" + sys.argv[2] + ID + "_" + ".txt", file=fout)
