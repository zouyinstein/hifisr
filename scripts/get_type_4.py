...
for line in lines:
    ...
    if Rep1 > 0 and Rep2 > 0:
        type = "type_4_rep1_rep2"
    elif Rep1 > 0 and Rep2 == 0:
        type = "type_4_rep1_ref2"
    elif Rep1 > 0 and Rep2 < 0:
        type = "type_4_rep1_ins2"
    elif Rep1 == 0 and Rep2 > 0:
        type = "type_4_ref1_rep2"
    elif Rep1 == 0 and Rep2 == 0:
        type = "type_4_ref1_ref2"
    elif Rep1 == 0 and Rep2 > 0:
        type = "type_4_ref1_ins2"
    elif Rep1 < 0 and Rep2 > 0:
        type = "type_4_ins1_rep2"
    elif Rep1 < 0 and Rep2 == 0:
        type = "type_4_ins1_ref2"
    elif Rep1 < 0 and Rep2 < 0:
        type = "type_4_ins1_ins2"
    else:
        type = "other"
    if Rep3 > 0:
        type = type + "_rep3"
    ...
    new_line = "\t".join((query_id, length, type, str(Rep1), str(Rep2), str(Rep3), strand1, query_start1, query_end1, sbjct_start1, sbjct_end1, strand2, query_start2, query_end2, sbjct_start2, sbjct_end2, strand3, query_start3, query_end3, sbjct_start3, sbjct_end3, strand4, query_start4, query_end4, sbjct_start4, sbjct_end4))
    print(new_line)
